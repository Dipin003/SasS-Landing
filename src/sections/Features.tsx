                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
                    ...
                    >
                        <div className="aspect-video flex items-center justify-center">
                            <Aavatar className="z-40">
                                <Image src={avatar1} alt="Avatar 1" className="rounded-full" />
                            </Aavatar>
                            <Aavatar className="-ml-6 border-indigo-500 z-30">
                                <Image src={avatar2} alt="Avatar 2" className="rounded-full" />
                            </Aavatar>
                            <Aavatar className="-ml-6 border-amber-500 z-20">
                                <Image src={avatar3} alt="Avatar 3" className="rounded-full" />
                            </Aavatar>

                            <Aavatar className="-ml-6 border-transparent rounded-full group-hover:border-green-500 trnasition-all">
                            ...
                            <p className="text-4xl font-extrabold text-white/20 text-center group-hover:text-white/10 transition duration-500">
                                ...
                                <span className="bg-gradient-to-r from-purple-400 to bg-pink-400 bg-clip-text text-transparent relative">
                                    ...
                                    <video src="/assets/gif-incredible.mp4"
                                        ...
                                        className="absolute bottom-full left-1/2 -translate-x-1/2 rounded-2xl shadow-xl opacity-0 group-hover:opacity-100 transition  
                    ...
                    >
                        <div className="aspect-video flex items-center justify-center gap-4">
                            <Key className="w-28 group-hover:outline outline-2 outline-offset-4 outline-lime-400 transition-all duration-500  group-hover:translate-y-1">shift</Key>
                            <Key className="group-hover:outline outline-2 outline-offset-4 outline-lime-400 transition-all duration-500  group-hover:translate-y-1">alt</Key>
                            <Key className="group-hover:outline outline-2 outline-offset-4 outline-lime-400 transition-all duration-500  group-hover:translate-y-1">C</Key>
                        </div>
                    </FeatureCard>
                </div>
