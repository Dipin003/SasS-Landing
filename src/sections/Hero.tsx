    ...
    return (
        <section className="py-24 overflow-x-clip">
            <div className="container relative">
                ...
                <div className="absolute -left-64 top-16">
                ...
                <h1 className="text-2xl md:text-6xl lg:text-7xl max-w-2xl ml-40 font-medium text-center mt-6 tracking-wide">Impactful design, created effortlessly</h1>
